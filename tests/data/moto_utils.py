"""
This file is a shameless copy of moto's tests/test_swf/utils.py.
It aims at defining various helpers and data structures useful for testing
SWF related code.
"""
import boto
